<template>
  <div id="userLayout" class="w-full h-full">
    <div
      class="flex items-center justify-center w-full h-full min-h-screen bg-white"
    >
      <div
        class="z-[999] pt-12 pb-10 md:w-96 w-10/12 rounded-lg flex flex-col box-border"
      >
