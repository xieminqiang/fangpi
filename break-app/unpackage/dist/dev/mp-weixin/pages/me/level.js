...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    common_vendor.onMounted(() => {
      if (userStore.token) {
        common_vendor.index.__f__("log", "at pages/me/level.vue:179", "已有 token，直接加载等级配置");
        loadLevelConfigs();
      } else {
        common_vendor.index.__f__("log", "at pages/me/level.vue:182", "暂无 token，等待登录完成...");
      }
      common_vendor.index.$on("loginSuccess", onLoginSuccess);
    });
    const onLoginSuccess = () => {
      common_vendor.index.__f__("log", "at pages/me/level.vue:191", "收到 loginSuccess 事件，开始加载等级配置");
      loadLevelConfigs();
    };
      ...
      try {
        ...
        if (response.data.code === 0) {
          ...
          if (Array.isArray(rawData)) {
            ...
            common_vendor.index.__f__("log", "at pages/me/level.vue:215", "✅ 等级配置加载成功", levelList.value);
          } else {
            common_vendor.index.__f__("error", "at pages/me/level.vue:217", "❌ 返回的数据不是数组:", rawData);
          ...
          common_vendor.index.__f__("error", "at pages/me/level.vue:224", "❌ API 返回错误:", response.data.msg);
          common_vendor.index.showToast({
        ...
        common_vendor.index.__f__("error", "at pages/me/level.vue:231", "❌ 加载等级配置失败:", error);
        common_vendor.index.showToast({
          title: "加载失败，请重试",
          icon: "error"
        });
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-157e7739"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/me/level.js.map
