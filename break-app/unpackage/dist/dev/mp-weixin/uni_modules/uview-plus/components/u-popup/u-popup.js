...
if (!Array) {
  ...
  (_easycom_u_overlay2 + _easycom_u_status_bar2 + _component_up_icon + _easycom_u_safe_bottom2 + _easycom_u_transition2)();
}
...
if (!Math) {
  (_easycom_u_overlay + _easycom_u_status_bar + _easycom_u_safe_bottom + _easycom_u_transition)();
}
